    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-gray-900 mb-3 tracking-tight text-center">SoulJournal</h1>
          <p className="text-gray-500 text-center">Welcome back! Your diary awaits.</p>
        </div>
...
export const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      setError(result.error || 'Registration failed. Check details.');
    }
    setIsLoading(false);
  };
        ...
        <div className="w-full max-w-md bg-white rounded-[2.5rem] p-10 text-center shadow-2xl border border-gray-100">
          {verifiedSuccessfully ? (
            <div className="animate-slide-up">
              <div className="inline-flex items-center justify-center bg-green-100 p-6 rounded-full text-green-600 mb-6">
                <CheckCircle2 className="w-16 h-16" />
              </div>
              <h2 className="text-3xl font-black text-gray-900 mb-2">Success!</h2>
              <p className="text-gray-500">Your email is verified. Redirecting...</p>
            </div>
          ) : (
            <>
              <div className="inline-flex items-center justify-center bg-indigo-50 p-4 rounded-full text-indigo-600 mb-6">
              ...
              {showOtpInput ? (
                <form onSubmit={handleOtpVerify} className="space-y-6 animate-slide-up">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        maxLength={6}
                        placeholder="000000"
                        className="w-full pl-12 pr-4 py-5 bg-gray-50 border-2 border-transparent focus:bg-white focus:border-indigo-500 rounded-2xl outline-none transition-all text-center text-3xl font-black tracking-[0.4em]"
                        value={otpToken}
                  ...
                  >
                    {isVerifyingOtp ? <Loader2 className="w-5 h-5 animate-spin" /> : 'Confirm Code'}
                  </button>
                ...
                <div className="space-y-4">
                  ...
                  <Link 
                    to="/login"
                    className="block w-full text-gray-400 font-bold py-2 hover:text-gray-600"
                  >
                    Back to Login
                  </Link>
                </div>
